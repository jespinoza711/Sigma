...
{
    public class DetalleGrupoSistemaComponenteConfiguracion
        : EntityTypeConfiguration<DetalleGrupoSistemaComponente>
    {
        public DetalleGrupoSistemaComponenteConfiguracion()
        {
